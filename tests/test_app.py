...
class TestFileUpload:
    ...
    def test_upload_single_vcf(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
        ...
        try:
            response = client.post(
                '/',
                data={'vcf_files': (open(data['vcf_files'][0].name, 'rb'), 'patient001.vcf')},
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_upload_multiple_vcf(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
    ...
    def test_upload_non_vcf_file(self, client):
        ...
        data = {
            'vcf_files': (tempfile.NamedTemporaryFile(suffix='.txt', delete=False), 'test.txt')
        }
...
class TestDatabaseOperations:
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_patient_creation(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_variant_creation(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
        ...
        try:
            ...
            with app.app_context():
                ...
                assert '★' in variant1.review_status_stars or variant1.review_status_stars == ''
        finally:
            os.unlink(tf.name)
    
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_patient_variant_link(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_duplicate_patient_not_created(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
...
class TestAnnotationProcessing:
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_molecular_consequence_extraction(self, mock_pipeline, client, sample_vcf_content):
        ...
        mock_data = {
            'chr1:7984930:A:C': {
                ...
                'genes': [{'symbol': 'GENE1'}],
                'protein_change': 'p.Lys41Asn',
                'molecular_consequences': ['splice_acceptor_variant', 'missense_variant', 'intron_variant'],
                'review_status': 'criteria provided, single submitter',
                'clinical_significance': 'Pathogenic',
                'trait_name': 'Test Disease',
                'trait_omim': '123456',
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_review_status_stars_mapping(self, mock_pipeline, client, sample_vcf_content):
...
class TestRendering:
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_variant_table_rendered(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_clinvar_url_generated(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
        ...
        try:
            ...
            assert b'https://www.ncbi.nlm.nih.gov/clinvar/variation/999888' in response.data
            assert b'https://www.ncbi.nlm.nih.gov/clinvar/variation/777666' in response.data
        finally:
            os.unlink(tf.name)
...
class TestDatabasePersistence:
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_data_persists_across_requests(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_same_variant_different_patients(self, mock_pipeline, client, sample_vcf_content):
        ...
        try:
            ...
            with app.app_context():
                ...
                variant = variants[0]
                patient_ids = {link.patient.patient_id for link in variant.patient_links}
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_database_rollback_on_error(self, mock_pipeline, client, sample_vcf_content):
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_variant_uniqueness_by_vcf_description(self, mock_pipeline, client, sample_vcf_content):
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_patient_variant_relationship_integrity(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_data_integrity_after_multiple_uploads(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
    ...
    def test_database_schema_integrity(self, client):
        ...
        with app.app_context():
            ...
            pv_columns = {col['name'] for col in inspector.get_columns('patient_variant')}
...
class TestEdgeCases:
    ...
    @patch('clinvar_anno_app.app.run_annotation_pipeline')
    def test_file_cleanup(self, mock_pipeline, client, sample_vcf_content, mock_annotation_data):
